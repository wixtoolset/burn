...
enum BOOTSTRAPPER_ENGINE_MESSAGE
{
    ...
    BOOTSTRAPPER_ENGINE_MESSAGE_RELATEDBUNDLE_GETVARIABLETYPE,
    BOOTSTRAPPER_ENGINE_MESSAGE_RELATEDBUNDLE_GETVARIABLENUMERIC,
    BOOTSTRAPPER_ENGINE_MESSAGE_RELATEDBUNDLE_GETVARIABLESTRING,
    // BOOTSTRAPPER_ENGINE_MESSAGE_RELATEDBUNDLE_GETVARIABLEVERSION,
};
...
typedef struct _BAENGINE_RELATEDBUNDLE_GETVARIABLETYPE_ARGS
{
    DWORD cbSize;
    LPCWSTR wzBundleId;
    LPCWSTR wzVariable;
} BAENGINE_RELATEDBUNDLE_GETVARIABLETYPE_ARGS;

typedef struct _BAENGINE_RELATEDBUNDLE_GETVARIABLETYPE_RESULTS
{
    DWORD cbSize;
    DWORD dwType;
} BAENGINE_RELATEDBUNDLE_GETVARIABLETYPE_RESULTS;

typedef struct _BAENGINE_RELATEDBUNDLE_GETVARIABLENUMERIC_ARGS
{
    DWORD cbSize;
    LPCWSTR wzBundleId;
    LPCWSTR wzVariable;
} BAENGINE_RELATEDBUNDLE_GETVARIABLENUMERIC_ARGS;

typedef struct _BAENGINE_RELATEDBUNDLE_GETVARIABLENUMERIC_RESULTS
{
    DWORD cbSize;
    // The contents of llValue may be sensitive, if variable is hidden should keep value encrypted and SecureZeroMemory.
    LONGLONG llValue;
} BAENGINE_RELATEDBUNDLE_GETVARIABLENUMERIC_RESULTS;

typedef struct _BAENGINE_RELATEDBUNDLE_GETVARIABLESTRING_ARGS
{
    DWORD cbSize;
    LPCWSTR wzBundleId;
    LPCWSTR wzVariable;
} BAENGINE_RELATEDBUNDLE_GETVARIABLESTRING_ARGS;

typedef struct _BAENGINE_RELATEDBUNDLE_GETVARIABLESTRING_RESULTS
{
    DWORD cbSize;
    ...
    // Should be initialized to the size of wzValue.
    DWORD cchValue;
} BAENGINE_RELATEDBUNDLE_GETVARIABLESTRING_RESULTS;

typedef struct _BAENGINE_RELATEDBUNDLE_GETVARIABLEVERSION_ARGS
{
    DWORD cbSize;
    LPCWSTR wzBundleId;
    LPCWSTR wzVariable;
} BAENGINE_RELATEDBUNDLE_GETVARIABLEVERSION_ARGS;

typedef struct _BAENGINE_RELATEDBUNDLE_GETVARIABLEVERSION_RESULTS
{
    DWORD cbSize;
    // The contents of qwValue may be sensitive, if variable is hidden should keep value encrypted and SecureZeroMemory.
    DWORD64 qwValue;
} BAENGINE_RELATEDBUNDLE_GETVARIABLEVERSION_RESULTS;
